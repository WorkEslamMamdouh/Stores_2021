...
namespace StkDefUnitGroup {
    var sys: SystemTools = new SystemTools();
    var SysSession: SystemSession = GetSystemSession();
    var Selected_Data: Array<I_D_UnitGroup> = new Array<I_D_UnitGroup>();

    var Data: Array<I_D_UnitGroup> = new Array<I_D_UnitGroup>();
    var Details: Array<I_D_UnitGroupUom> = new Array<I_D_UnitGroupUom>();
    var ModelGroup: I_D_UnitGroup = new I_D_UnitGroup();
    var ModelGroupUom: I_D_UnitGroupUom = new I_D_UnitGroupUom();
    var MasterModel: UnitGroup = new UnitGroup();
    var Display_D_UOM: Array<I_D_UOM> = new Array<I_D_UOM>();

    var compcode: number;
    var BranchCode: number;
    var Flag_Mastr;
    var txtUnitGrpCode: HTMLInputElement;
    ...
    var btnEdit_1: HTMLButtonElement;
    var btnSave_1: HTMLButtonElement;
    var btnBack_1: HTMLButtonElement;
    var btnAddDetails: HTMLButtonElement;
    var txtUomID: HTMLSelectElement;
    var divGrid: JsGrid = new JsGrid();
    var CountGrid = 0;
    var CountUnit: number = 0;
    var UnitGrpID = 0;
    ...
    export function InitalizeComponent() {
        ...
        else { document.getElementById('Screen_name').innerHTML = "Define UnitGroup"; }
    ...
    function InitalizeControls() {
        ...
        btnEdit_1 = document.getElementById("btnEdit_1") as HTMLButtonElement;
        ...
        //HTMLInputElement
        txtUnitGrpCode = document.getElementById("txtUnitGrpCode") as HTMLInputElement;
        txtDescA = document.getElementById("txtDescA") as HTMLInputElement;
        txtDescE = document.getElementById("txtDescE") as HTMLInputElement;
        txtRemarks = document.getElementById("txtRemarks") as HTMLInputElement;

        //HTMLSelectElement
        txtUomID = document.getElementById("txtUomID") as HTMLSelectElement;
    ...
    function Display() {
        ...
        Ajax.Callsync({
            ...
            success: (d) => {
                ...
                if (result.IsSuccess) {
                    Selected_Data = result.Response as Array<I_D_UnitGroup>;
                     

                    for (var i = 0; i < Selected_Data.length; i++) {   
                        var Display_UOM = Display_D_UOM.filter(x => x.UomID == Selected_Data[i].UomID);    
    ...
    function GridDoubleClick() {
        ...
        Data = new Array<I_D_UnitGroup>();


        Data = Selected_Data.filter(x => x.UnitGrpID == Number(divGrid.SelectedKey));
    ...
    function DisplayData(Selected_Data: Array<I_D_UnitGroup>) {
        debugger
        CountGrid = 0;
    ...
    function BindGetGridData(UomID: number) {
        Ajax.Callsync({
            type: "Get",
            ...
            success: (d) => {
                let result = d as BaseResponse;
                if (result.IsSuccess) {
                    Details = result.Response as Array<I_D_UnitGroupUom>;
                    $("#div_Data").html('');
                    CountGrid = 0;
    ...
    function checkRepeatedUOM(UOMValue: number, cnt: number) {

        var UOM: number = Number(CountGrid);//Error
        var flag = false;
        for (let i = 0; i < UOM; i++) {
        ...
        Ajax.Callsync({
            ...
            success: (d) => {
                ...
                if (result.IsSuccess == true) {
                    ...
                    Data = Selected_Data.filter(x => x.UnitGrpID == Number(UnitGrpID));
